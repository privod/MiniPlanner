...
public class PartyExpandableAdapter extends ExpandableRecyclerAdapter<Party, PartyContent, PartyExpandableAdapter.PartyViewHolder, PartyExpandableAdapter.PartyContentViewHolder> {

//    private List<Party> parties;

    public PartyExpandableAdapter() {
